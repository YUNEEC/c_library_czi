/** @file
 *    @brief MAVLink comm protocol testsuite generated from czi_minimal.xml
 *    @see http://qgroundcontrol.org/mavlink/
 */
#pragma once
#ifndef CZI_MINIMAL_TESTSUITE_H
#define CZI_MINIMAL_TESTSUITE_H
...
static void mavlink_test_czi_minimal(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
